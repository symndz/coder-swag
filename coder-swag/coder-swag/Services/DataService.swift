...
class DataService {
    ...
    private let shirts = [
        ...
        Product(title: "Devslopes Badge Shirt Logo Grey", price: "$19", image: "shirt02.png"),
    ...
    private let digitaGoods = [Product]()
    ...
    func getProducts(forCategoryTitle_friendlyName title: String) -> [Product] {
        switch title {
        case "SHIRTS":
            return getShirts()
        case "HATS":
